...
/** Admin/master-data view: salary component + optional org-wide fixed monthly amount. */
export interface SalaryComponentAdmin extends SalaryComponent {
  fixedMonthlyAmount: string | number | null
}
